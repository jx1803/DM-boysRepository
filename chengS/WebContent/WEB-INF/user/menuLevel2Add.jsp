...
<article class="page-container">
	<form action="<%=path %>user/Menu_Level2_save.action" method="post" class="form form-horizontal" id="form-admin-role-add" target="_parent">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>一级菜单：</label>
				...
				<select class="select" size="1" name="pid">
					...
					<c:forEach items="${ulist}" var="mlist">
						<option value="${mlist.permissionId }">${mlist.permission }</option>
					</c:forEach>
				</select>
			</span>
			</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>新增二级菜单名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="permission" name="permission">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>url（选填）：</label>
			<div class="formControls col-xs-8 col-sm-9">
