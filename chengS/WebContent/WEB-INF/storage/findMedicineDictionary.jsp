...
<div class="page-container">
	<div class="text-c"> 药品名称:
		...
		<button type="submit" class="btn btn-primary radius" id="" name=""> 搜索药品</button>
		<button type="submit" class="btn btn-primary radius" id="" name=""
		 onclick="system_data_edit('添加药品','addMedicineDictionary.action','0001','900','500')">
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td>城市</td>
					<td>city</td>
					<td class="f-14"><a style="text-decoration:none" onclick="system_data_edit('修改药品','updMedicineDictionary.action','0001','900','500')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
