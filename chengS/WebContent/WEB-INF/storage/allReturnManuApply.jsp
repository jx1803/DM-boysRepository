	...
	<div class="mt-20">
		...
		<div class="text-c">
			...
			<button type="button" class="btn btn-secondary-outline radius"
				...
				<input type="text" style="width:30px" class="input-text"  id="page" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
			<button type="submit" class="btn btn-secondary-outline radius" onclick="goPage('${pageTotal}')">跳转</button>
