...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a data-href="toDrugTypeInfo.action" data-title="药品类型" href="javascript:void(0)">药品类型</a></li>
					<li><a data-href="findDfInfo.action" data-title="药品剂型" href="javascript:void(0)">药品剂型</a></li>
					<li><a data-href="toMedicineDictionary.action" data-title="药品字典" href="javascript:void(0)">药品字典</a></li>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="toIndexInfo.action">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="toIndexInfo.action"></iframe>
	</div>
</div>
</section>
