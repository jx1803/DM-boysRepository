...
<body>
	...
	<div class="modal fade" id="updModal" tabindex="-1" role="dialog"
		...
		<form action="updDrugInventory.action" method="post" id="updForm">
		<div class="modal-dialog" style="width: 450px">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">修改库存限制</h4>
				</div>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												class="input-text" value="" placeholder="" id="minimum"
												name="minimum" datatype="*2-16" nullmsg="不能为空">
												<input type="hidden" id="inventoryId" name="inventoryId" /><br/>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group">
												<input type="text" style="width: 200px"
												class="input-text" value="" placeholder="" id="maximum"
												name="maximum" datatype="*2-16" nullmsg="不能为空"><br/>
												</div>
											</td>
										</tr>
									</tbody>
		...
		<div class="mt-20">
			<table
				...
				<c:forEach items="${inventoryList }" var="inventory" varStatus="vs">
					<tr class="text-c">
						<td>${vs.index+1}</td>
						<td>${inventory.drugId}</td>
						<td>${inventory.stoDrugBean.generalName}</td>
						<td>${inventory.inventoryNum}</td>
						<td>${inventory.minimum}</td>
						<td>${inventory.maximum}</td>
						<td class="f-14">
							<a style="text-decoration: none" 
							onclick="updModel('${inventory.inventoryId}','${inventory.minimum}','${inventory.maximum}')"  title="编辑">
