...
<form action="selectAdjustPrice.action" method="post" id="select">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<tr class="text-c">
				<td><a href="#" onclick="showAdjust('修改价格','adjustLayer.action?beforeAdjust=5&drugId=2',400,200)">万艾可</a></td>
			...
			<div class="modal-content">
				...
				<form action="" method="post" >
					...
					<tr>
						...
						<td><input type="text" class="form-control" name="beforePrice" id="beforePrice" ></td>
					</tr>
					<tr>
						<td width="170px" align="center">修改为：</td>
						<td><input type="text" class="form-control" name="afterPrice"  id="afterPrice" placeholder="输入修改价格" ></td>
					</tr>
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-primary" id="btupload">确定</button>
