...
<body>
	...
	<form action="toCancellingApplyList.action">
		<div class="text-c">
			...
			审核状态：<select name="checkId" class="input-text" style="width: 150px;">
	...
	<div class="mt-20">
		...
		<div class="text-c">
			<a
				...
				href="toCancellingApplyList.action?beforeDate=${condiBean.beforeDate}&afterDate=${condiBean.afterDate}&adminName=${condiBean.adminName}&page=${condiBean.pageNum+1}"><button
