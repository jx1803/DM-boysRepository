...
<script type="text/javascript">
	...
	function setValue(drugId, drugName, drugmanu, drugNum, handleNum, proDate,
			putBatch, manuBatch) {
		//给父窗口赋值
					...
					<tbody>
						<c:forEach items="${drugList }" var="drugList">
							<tr class="text-c">
								...
								<td>${drugList.batchDetailBean.putBatch }</td>
								<td>${drugList.batchDetailBean.manuBatch }</td>
								<td><button class="btn btn-success" onclick="setValue('${drugList.drugId}','${drugList.drugName}','${drugList.drugmanu}','${drugList.phaDrugBean.drugNum}','${drugList.batchDetailBean.handleNum}','${drugList.batchDetailBean.proDate}','${drugList.batchDetailBean.putBatch}','${drugList.batchDetailBean.manuBatch}')">确定</button></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
