...
<body>
	...
	<div class="text-c">
		药品编码：<input type="text" name="drugId" id="drugId" placeholder="药品编码"
			...
			href="javascript:;"
			onclick="member_add('选择药品','toChooseDrug.action','','510')"
		...
		&emsp;库存数量：<input type="text" id="inventoryNum" 
	...
	<form id="fapply" action="takeDrugAppleFor.action" method="post"></form>
	<div class="mt-20">
		<table
